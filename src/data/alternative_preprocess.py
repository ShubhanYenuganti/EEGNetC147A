...
Usage:
    python src/data/alternative_preprocess.py

Output per subject/split (e.g. A01T):
    data/processed/bci_competition_iv_2a_128/A01T_X.npy  — (n_trials, 22, 256)
    data/processed/bci_competition_iv_2a_128/A01T_y.npy  — (n_trials,)
    data/processed/bci_competition_iv_2a_128/A01T_run.npy — (n_trials,)
